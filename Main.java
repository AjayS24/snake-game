...
class GamePanel extends JPanel implements ActionListener{  //jPanel - simple container class                                       interface
    ...
    public void gameOver(Graphics g) {
        ...
        try {
            ...
            if(previousHighScore < applesEaten ) HighScoreHolder = UserName;
            ...
            g.drawString("High Score:"+HighScoreHolder+" - " +HighScore, (SCREEN_WIDTH - metrics1.stringWidth("High Score:"+HighScoreHolder+" - " +HighScore))/2, 75);
            try {
        ...
        g.drawString("Press \"enter\" to play again", (SCREEN_WIDTH - metrics2.stringWidth("Press \"enter\" to play again"))/2, 500);
